...
//     "Single", "Double", "Triple", "Non Residential", "Online"
//   ];
//   const countries = [
//     "India", "United States", "United Kingdom", "Australia", "Canada", "Germany", "France", "Other"
//   ];
...
//   const destinations = retreat && Array.isArray(retreat.location)
//     ? retreat.location
//     : retreat && typeof retreat.location === 'string'
//       ? [retreat.location]
//       : []; // You can expand this if you have more destinations

//   const handleBookAndPay = async () => {
//     if (!name || !email || !phone || !wellnessProgram || !accommodation || !date || !country || !destination || !numPersons || !agreed) {
...
//             </div>
//             {showBookingForm && (
//               <div className="bg-gray-50 p-4 sm:p-6 rounded-xl border border-gray-200 space-y-3 sm:space-y-4 mt-4 max-w-xl mx-auto">
//                 <h3 className="text-lg font-semibold text-gray-900 mb-2">Book your spot</h3>
...
//                   <div>
//                     <label className="block font-semibold mb-1">Wellness program</label>
//                     <select
...
//                 </div>
//                 <div className="mb-2">
//                   <label className="block font-semibold mb-1">Accommodation options</label>
//                   <div className="flex flex-wrap gap-4">
...
//                   </div>
//                   <div>
//                     <label className="block font-semibold mb-1">Number of person</label>
//                     <select
//                       className="w-full border rounded-lg p-2"
//                       value={numPersons}
...
//                   <input
//                     type="text"
//                     value={`₹${retreat.price ? retreat.price.toFixed(2) : '1000.00'} per person`}
...
//                   className="w-full bg-gray-200 text-gray-700 py-2 rounded-lg font-semibold mt-2"
//                 >
//                   Cancel
//                 </button>
//               </div>
    ...
    <div className="min-h-screen bg-white md:mt-24 mt-20">
                ...
                {retreat.teachers && retreat.teachers.length > 0 ? (
                  retreat.teachers.map((teacher, index) => (
                    <div
                      ...
                      className="flex bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden"
                    >
                      <div className="w-1/6 h-90 bg-gray-200 flex-shrink-0">
                        <Image
                          src={teacher.image_url || teacherPlaceholder}
                          alt={teacher.name}
                          width={200}
      ...
      {showBookingForm && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900/30 backdrop-blur-md">
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-200 shadow-2xl space-y-4 sm:space-y-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block font-semibold text-gray-700 mb-1">Wellness Program</label>
                <select
            ...
            <div>
              <label className="block font-semibold text-gray-700 mb-1">Accommodation Options</label>
              <div className="flex flex-wrap gap-4">
                {accommodationOptions.map(opt => (
                  <label key={opt} className="flex items-center">
                    <input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block font-semibold text-gray-700 mb-1">Number of Persons</label>
                <select
                  className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-yellow-400 focus:outline-none"
                  value={numPersons}
                  onChange={e => setNumPersons(e.target.value)}
