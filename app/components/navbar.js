...
const Navbar = () => {
  ...
  return (
    <nav 
      ...
      className="bg-white/95 backdrop-blur-sm border mt-5 border-gray-200 rounded-3xl shadow-sm max-w-360 mx-auto sticky top-4 z-50"
    >
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center justify-end flex-grow space-x-8">
            <Link 
              href="/retreat" 
